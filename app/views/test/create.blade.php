            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::select('department', [' ' => '--- Select department ---','0' => 'IM','1' => 'GO', '2'=>'Ped', '3'=>'ENT/ORL', '4'=>'Dermato', '5'=>'Stomato', '6'=>'Ophtalmo', '7'=>'Surg', '8'=>'Emergency', '9'=>'ICU', '10'=>'Dialysis','11'=>'ARV Ped','12'=>'ARV IM', '13'=>'Hospital outside'], null,
									 array('id' => 'department','class' => 'form-control')) }}
                    </div>
					<div class="form-group hospital">
                        {{ Form::label('hospital', 'Hospital') }}
                        {{Form::text('hospital', Input::old('hospital'), array('id'=>'hospital','placeholder'=>'Reffering hospital','class' => 'form-control'))}}
                    </div>
                    <div class="form-group">
					...
					<div class="form-group wardBed" >
						...
						<select name="ward" id='selectWard' class='form-control'>
							<option id='ward' value='' selected> Select ward</option>
						</select>
                    </div>
					<div class="form-group wardBed">
                        {{ Form::label('bed', 'Bed') }}
                        {{Form::text('bed', Input::old('bed'), array('id'=>'bed','placeholder'=>'Bed','class' => 'form-control'))}}
                    </div>
                    <div class="form-group">
                         {{ Form::label('visit_urgency', 'Visit urgency') }}
                        <label class="radio-inline">{{ Form::radio('visit_urgency', 'urgent', null) }} <strong>Urgent!!</strong></label>
                        <label class="radio-inline">{{ Form::radio('visit_urgency', 'not_urgent', null)}} <strong>Not urgent</strong></label>
                        
                    </div>
                    <div class="form-group">
                        {{ Form::label('physician', trans("messages.physician")) }}
                        {{-- {{Form::text('physician', Input::old('physician'), array('placeholder'=>'Requesting Dr','class' => 'form-control'))}} --}}
                    {{ Form::select('physician', ['' => '--- Select Clinician ---','Not readable' => 'Not readable','Not listed' => 'Not listed']+$clinicians, Input::old('physician'),
                    ...
                    <div class="form-group nonListedClinician">
                        ...
                        {{Form::text('nonListedClinician', Input::old('nonListedClinician'), array('id'=>'nonListedClinician','placeholder'=>'Type the name','class' => 'form-control'))}}
                    </div>

					<div class="form-group">
                        {{ Form::label('clinicinfo', trans("messages.clinicinfo")) }}
                        {{Form::textarea('clinicinfo', Input::old('clinicinfo'), array('class' => 'form-control'))}}
                    </div>
                    <div class="form-group">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><label  class="editor-active">
												{{Form::checkbox('testtypes[]', $value->id, Input::old('testtypes[]'))}}
