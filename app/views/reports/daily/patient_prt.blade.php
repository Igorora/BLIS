		  	...
		  	<table class="table table-bordered">
				<tbody>
					...
					<tr>
						...
						<td>{{ $visit->patient->getAge(null,$visit->created_at) }}</td>
						...
						<td>
							@foreach($visit->tests as $test)
								...
								<?php 
								   ...
								   $registeredBy=$test->createdBy->name;
								   $registeredOn=$test->time_created;
